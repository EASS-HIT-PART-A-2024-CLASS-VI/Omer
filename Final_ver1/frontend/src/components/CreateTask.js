...
function CreateTask({ onSubmit, editingTask }) {
  const navigate = useNavigate();
  const [title, setTitle] = useState(editingTask?.title || '');
  const [description, setDescription] = useState(editingTask?.description || '');
  const [startTime, setStartTime] = useState(editingTask?.start_time ? new Date(editingTask.start_time) : null);
  const [endTime, setEndTime] = useState(editingTask?.end_time ? new Date(editingTask.end_time) : null);
